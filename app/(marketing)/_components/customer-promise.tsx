...
const CustomerPromise = () => {
  return (
    <section className="text-white px-4 lg:px-0">
      <div className="bg-darkblue max-w-7xl mx-auto px-8 py-16 rounded-2xl">
        <div className="grid grid-cols-4 gap-4">
          <div className="col-span-4 md:col-span-2">
            ...
            <p className="text-xs md:text-base lg:text-lg mt-4">
              All <span className="italic text-lightblue">Simukuza Auto</span> vehicles go through a detailed inspection by our
          ...
          <div className="col-span-4 md:col-span-2 gap-2 grid md:grid-cols-2 ">
            ...
            <div className="flex items-center space-x-2">
              ...
              <p className="text-white text-sm md:text-md">
                ...
                <span className="text-lightblue">9 months minimum </span>MOT test
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <CircleCheck className="text-lightblue h-6 w-6 shrink-0" />
              <p className="text-white text-sm md:text-md">
                ...
                <span className="text-lightblue">vehicle history </span>& mileage
                check
              </p>
            </div>
            <div className="flex items-center space-x-2">
